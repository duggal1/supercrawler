---
title: FaunaDB Examples & Use Cases | Vercel
description: No description
keywords: No keywords
canonicalUrl: https://vercel.com/templates/fauna
---
...
# FaunaDB examples and use cases

Discover FaunaDB examples and templates for different use cases.
...
[Static.funWildcard domains with Next.js, Fauna, and Pusher.by▲ Vercel](/templates/next.js/static-fun-wildcard-domains)

[Fauna Starter KitA guestbook template for builders to build with Next.js and Fauna.by▲ Vercel](/templates/next.js/fauna-starter-kit)
