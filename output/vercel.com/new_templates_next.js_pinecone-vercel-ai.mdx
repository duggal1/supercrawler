...
canonicalUrl: https://vercel.com/new/templates/next.js/pinecone-vercel-ai
---
...
[nicoalbanese/pinecone-vercel-starter](https://github.com/nicoalbanese/pinecone-vercel-starter/tree/na/update-ai-sdk)
...
[Deploy](/new/clone?demo-deion=A%20Next.js%20starter%20chatbot%20using%20Vercel%27s%20AI%20SDK%20and%20implements%20the%20Retrieval-Augmented%20Generation%20(RAG)%20pattern%20with%20Pinecone&demo-image=%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1G4xSqx0bCgVVv3aY3rrX4%2Ffa27791c39ddf058995561d794a68710%2FCleanShot_2023-07-21_at_11.55.49.png&demo-title=Pinecone%20-%20Vercel%20AI%20SDK%20Starter&demo-url=https%3A%2F%2Fpinecone-vercel-example.vercel.app%2F&env=OPENAI_API_KEY%2CPINECONE_API_KEY%2CPINECONE_ENVIRONMENT%2CPINECONE_INDEX&envDeion=How%20to%20get%20these%20env%20vars%3A&envLink=https%3A%2F%2Fgithub.com%2Fpinecone-io%2Fpinecone-vercel-starter%2Fblob%2Fmain%2F.env.example&from=templates&project-name=Pinecone%20-%20Vercel%20AI%20SDK%20Starter&repository-name=pinecone-vercel-ai&repository-url=https%3A%2F%2Fgithub.com%2Fnicoalbanese%2Fpinecone-vercel-starter%2Ftree%2Fna%2Fupdate-ai-sdk&skippable-integrations=1)

[View Demo](https://pinecone-vercel-example.vercel.app/)
...
![Pinecone AI SDK](/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1G4xSqx0bCgVVv3aY3rrX4%2Ffa27791c39ddf058995561d794a68710%2FCleanShot_2023-07-21_at_11.55.49.png&w=3840&q=75)
...
Next.js is a powerful Java framework that enables us to build server-side rendered and static web applications using React. It's a great choice for our project due to its ease of setup, excellent performance, and built-in features such as routing and API routes.
...
1. Update the state with the response from the backend
1. Handle any internal state changes (e.g. when the user types a message)
...
First, we'll first focus on seeding the knowledge base. We'll create a crawler and a seed , and set up a crawl endpoint. This will allow us to gather and organize the information our chatbot will use to provide contextually relevant responses.
...
1. `MarkdownTextSplitter`- This splitter splits the text into chunks based on Markdown s. This method is useful for documents that are already structured using Markdown. The benefit of this method is that it will split the document into chunks based on the s, which will be useful for our chatbot to understand the structure of the document. We can assume that each unit of text under a  is an internally coherent unit of information, and when the user asks a question, the retrieved context will be internally coherent as well.
...
[ChatHN – Chat with Hacker NewsAI chatbot that uses OpenAI Functions and Vercel AI SDK to interact with the Hacker News API with natural language.bySteven Tey](/new/templates/next.js/chathn)
